...
export async function get<T>(key: string): Promise<T | null> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache GET error for key "${key}"`);
    return null;
  }
}
...
export async function set(key: string, value: unknown, ttlSeconds?: number): Promise<void> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache SET error for key "${key}"`);
  }
}
...
export async function del(key: string): Promise<void> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache DEL error for key "${key}"`);
  }
}
...
export async function delPattern(pattern: string): Promise<void> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache DEL pattern error for "${pattern}"`);
  }
}
...
export async function exists(key: string): Promise<boolean> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache EXISTS error for key "${key}"`);
    return false;
  }
}
...
export async function ttl(key: string): Promise<number> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache TTL error for key "${key}"`);
    return -2;
  }
}
...
export async function incrementCounter(
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache INCR error for key "${key}"`);
    return 1;
  }
}
...
export async function getCounter(key: string): Promise<number> {
  ...
  try {
    ...
    logger.error({ err: err instanceof Error ? err.message : err }, `Cache GET counter error for key "${key}"`);
    return 0;
  }
}
