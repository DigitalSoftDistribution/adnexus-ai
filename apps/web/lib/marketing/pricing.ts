...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    id: 'growth',
    name: 'Growth',
    description: 'For solo marketers and lean teams running multi-platform ads.',
    monthlyPrice: 49,
    annualMonthlyPrice: 39,
    cta: 'Start 14-Day Trial',
    ctaHref: '/auth/signup',
    popular: false,
    highlights: ['3 ad accounts', 'AI Agent + draft approvals', 'Weekly Morning Brief'],
    features: [
    ...
    notIncluded: ['TikTok + Snapchat', 'Approval workflows', 'API access'],
  },
  {
    id: 'scale',
    name: 'Scale',
