...
const comparisonCategories: ComparisonCategory[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Scale plan', adnexus: '$149/mo flat', pipeboard: '$149/mo' },
...
export function ComparePipeboardContent() {
        ...
        >
          ...
          >
            ...
            <blockquote
              ...
              style={{ color: 'var(--text-primary)' }}
            >
              Pipeboard lets you chat with your ad data. AdNexus lets you{' '}
              <span style={{ color: 'var(--accent)' }}>see it, govern it, and approve every change</span>{' '}
              — a visual workspace and draft-first controls on top of the same MCP-native foundation.
            </blockquote>
          </div>
        </motion.div>
      </section>
