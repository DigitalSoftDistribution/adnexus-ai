...
const comparisonCategories: ComparisonCategory[] = [
  ...
  },
  {
    ...
    icon: Zap,
    rows: [
      { feature: 'Rule-Based Automation', adnexus: true, birch: true, note: 'Revealbot excels here' },
      { feature: 'Audience Management', adnexus: true, birch: true, note: 'Revealbot has strong audience tools' },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Growth plan', adnexus: '$49/mo', birch: '$49/mo' },
      { feature: 'Scale plan', adnexus: '$149/mo flat', birch: '$99/mo' },
...
const differentiators = [
  {
    ...
    description:
      'Every change is staged for approval before touching live campaigns. Revealbot deploys directly; we deploy drafts.',
  ...
  },
  {
    ...
    description:
      'Flat-rate plans with no hidden fees or add-on costs. Revealbot charges extra for advanced features that we include standard.',
...
export function CompareRevealbotContent() {
      ...
      <section className="relative overflow-hidden px-6 pt-20 pb-24">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1, ease: easeSmooth }} className="font-space text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            <span className="text-gradient-blue">The Revealbot Alternative</span>
            <br />
      ...
      <section ref={tableRef} className="px-6 pb-24">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.5, ease: easeSmooth }} className="text-center mb-12">
            ...
            <p className="font-inter text-base" style={{ color: 'var(--text-secondary)' }}>See how AdNexus AI stacks up against Revealbot (Birch)</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: easeSmooth }} className="overflow-x-auto rounded-xl" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
            <div className="grid items-center" style={{ gridTemplateColumns: '1fr 140px 140px', minWidth: '520px', background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border-subtle)' }}>
              ...
              <div className="px-4 sm:px-6 py-4 font-inter text-xs font-semibold uppercase tracking-wider text-center" style={{ color: 'var(--text-tertiary)' }}>Revealbot</div>
            </div>
      ...
      <section className="px-6 pb-24">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.5, ease: easeSmooth }} className="text-center mb-12">
            ...
            <p className="font-inter text-base max-w-xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Revealbot is strong on rules and audiences. But if you want AI-native workflows with draft-first safety, AdNexus delivers.</p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Users, title: 'Multi-Account', desc: 'Scoped per-client access with isolated dashboards.', color: '#60A5FA' },
              { icon: Shield, title: 'Draft-First', desc: 'Every change staged for approval. Revealbot skips this.', color: '#34D399' },
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: easeSmooth }} className="max-w-3xl mx-auto text-center">
          <div className="relative overflow-hidden rounded-xl p-8 sm:p-12" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
            ...
            <blockquote className="font-space text-xl sm:text-2xl font-medium leading-relaxed" style={{ color: 'var(--text-primary)' }}>
              Revealbot makes you hand-write every rule. AdNexus is{' '}
              <span style={{ color: 'var(--accent)' }}>AI-native — it proposes the changes, you approve them</span>{' '}
              — with draft-first review that catches misconfigured audiences before they ever go live.
            </blockquote>
          </div>
        </motion.div>
      </section>
