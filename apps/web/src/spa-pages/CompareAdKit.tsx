...
export default function CompareAdKit() {
  ...
  return (
    <div className="min-h-screen bg-[#08090a] text-white">
      <SEO
        title="AdNexus AI vs AdKit — 4 Platforms, Team Workspaces, White-Label Reports"
        description="Compare AdNexus AI vs AdKit. Broader platform support, team workspaces, scheduled reports, and MCP-native AI agent integration."
      />
        ...
        <div className="mx-auto max-w-3xl text-center">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <div className="mt-8 flex justify-center gap-4">
              <a href="/signup" className="rounded-lg bg-sky-500 px-8 py-3 font-semibold text-white shadow-lg shadow-sky-500/25 transition hover:bg-sky-400">
                Start Free Audit
              </a>
