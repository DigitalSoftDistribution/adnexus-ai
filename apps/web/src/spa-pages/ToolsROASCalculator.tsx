...
export default function ToolsROASCalculator() {
  ...
  return (
    <div className="min-h-screen bg-[#08090a] text-white">
      <SEO
        ...
        description="Free ROAS calculator for Meta, Google, TikTok ads. Calculate ROAS, CPA, CPC, CTR, and CVR instantly with industry benchmarks."
      />
