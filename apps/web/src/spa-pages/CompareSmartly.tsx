...
const comparisonCategories: ComparisonCategory[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Pro Plan', adnexus: '$99/mo flat', smartly: 'Custom', note: 'Enterprise pricing only' },
...
export default function CompareSmartly() {
  ...
  return (
    ...
    <SEO
      ...
      description="Compare AdNexus AI with Smartly.io. Self-serve pricing, 2-minute setup, and AI-native campaign management without enterprise contracts."
      keywords="AdNexus vs Smartly.io, Smartly alternative, self-serve ad management, AI ad platform"
    />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: easeSmooth }} className="max-w-3xl mx-auto text-center">
          <div className="relative overflow-hidden rounded-xl p-8 sm:p-12" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
            ...
            <blockquote className="font-space text-xl sm:text-2xl font-medium leading-relaxed mb-6" style={{ color: 'var(--text-primary)' }}>
              &ldquo;We spent 3 weeks in Smartly&apos;s sales process before even seeing the product. With AdNexus, I signed up during a coffee break and had my first AI optimization running 10 minutes later.&rdquo;
            </blockquote>
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 rounded-full flex items-center justify-center font-space text-sm font-semibold" style={{ background: 'var(--bg-hover)', color: 'var(--accent)', border: '1px solid var(--border-subtle)' }}>JL</div>
              <div className="text-left">
                <p className="font-inter text-sm font-medium" style={{ color: 'var(--text-primary)' }}>Jamie Liu</p>
                <p className="font-inter text-xs" style={{ color: 'var(--text-tertiary)' }}>Growth Lead, Series A SaaS</p>
              </div>
            </div>
          </div>
        </motion.div>
