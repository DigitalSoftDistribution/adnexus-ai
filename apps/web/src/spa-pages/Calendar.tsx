...
type EventStatus = 'Active' | 'Running' | 'Scheduled' | 'Ended' | 'Draft' | 'Generated' | 'Due' | 'Optimizing' | 'Review' | 'Pending'
...
const isDemo = !apiUrl || apiUrl.includes('localhost') || apiUrl === ''

/* ─────────────────────── enriched mock data (30-day view) ─────────────────────── */

function generateMockEvents(): CalendarEvent[] {
  const now = new Date()
  const y = now.getFullYear()
  const m = String(now.getMonth() + 1).padStart(2, '0')
  const pad = (d: number) => `${y}-${m}-${String(d).padStart(2, '0')}`
  ...
  return [
    /* ═══════════════════ CAMPAIGN LAUNCHES ═══════════════════ */
    {
      ...
      endDate: pad(14),
      budget: '$750/day',
      notes: 'Multi-audience retargeting campaign for summer collection',
    },
    {
      id: 'c2',
      title: 'Google Search Brand Lift',
      platform: 'Google',
      status: 'Active',
      type: 'campaign',
      startDate: pad(1),
      endDate: pad(30),
      budget: '$520/day',
      notes: 'Brand keywords + competitor conquesting across 12 ad groups',
    },
    {
      id: 'c3',
      title: 'TikTok Spark Ads — Influencer Series',
      platform: 'TikTok',
      status: 'Active',
      type: 'campaign',
      startDate: pad(3),
      endDate: pad(20),
      budget: '$480/day',
      notes: 'Whitelisted influencer content with spark ads amplification',
    },
    {
      id: 'c4',
      title: 'Snapchat Story Ads Promo',
      platform: 'Snap',
      status: 'Scheduled',
      type: 'campaign',
      startDate: pad(5),
      endDate: pad(18),
      budget: '$320/day',
      notes: 'AR lens + story ads combo for product drop awareness',
    },
    {
      id: 'c5',
      title: 'Meta Retargeting Q3 Refresh',
      platform: 'Meta',
      status: 'Scheduled',
      type: 'campaign',
      startDate: pad(7),
      endDate: pad(28),
      budget: '$680/day',
      notes: 'Refreshed creative assets with new lookalike audiences',
    },
    {
      id: 'c6',
      title: 'YouTube Pre-Roll Launch',
      platform: 'Google',
      status: 'Scheduled',
      type: 'campaign',
      startDate: pad(10),
      endDate: pad(25),
      budget: '$900/day',
      notes: '15s and 30s skippable pre-roll with custom intent audiences',
    },
    {
      id: 'c7',
      title: 'TikTok Shop Live Campaign',
      platform: 'TikTok',
      status: 'Running',
      type: 'campaign',
      startDate: pad(12),
      endDate: pad(22),
      budget: '$550/day',
      notes: 'Live shopping event with product showcase and exclusive discounts',
    },
    {
      id: 'c8',
      title: 'Snap AR Try-On Campaign',
      platform: 'Snap',
      status: 'Active',
      type: 'campaign',
      startDate: pad(14),
      endDate: pad(30),
      budget: '$400/day',
      notes: 'AR lens campaign driving virtual try-on engagement',
    },
    {
      id: 'c9',
      ...
      endDate: pad(30),
      budget: '$1,200/day',
      notes: 'ASC campaign with broad targeting and catalog optimization',
    },
    {
      id: 'c10',
      title: 'Google PMax — New Markets',
      platform: 'Google',
      status: 'Scheduled',
      type: 'campaign',
      startDate: pad(18),
      endDate: pad(30),
      budget: '$850/day',
      notes: 'Performance Max expansion into 3 new geographic markets',
    },
    {
      id: 'c11',
      title: 'TikTok TopView Takeover',
      platform: 'TikTok',
      status: 'Scheduled',
      type: 'campaign',
      startDate: pad(20),
      endDate: pad(21),
      budget: '$3,500/day',
      notes: 'One-day homepage takeover for major product announcement',
    },
    {
      id: 'c12',
      ...
      endDate: pad(30),
      budget: '$280/day',
      notes: 'RLSA + dynamic remarketing for cart abandoners',
    },
    ...
    /* ═══════════════════ AI OPTIMIZATION EVENTS ═══════════════════ */
    {
      ...
      type: 'draft',
      startDate: pad(2),
      notes: 'AI shifted $1,200 from underperforming Snap campaign to Meta retargeting (+18% ROAS)',
    },
    {
      id: 'a2',
      title: 'AI Creative Refresh Suggestion',
      platform: 'AI Agent',
      status: 'Review',
      type: 'draft',
      startDate: pad(4),
      notes: '4 ad creatives flagged for fatigue (>2.5 frequency). Replacement variants generated.',
    },
    {
      id: 'a3',
      ...
      type: 'draft',
      startDate: pad(6),
      notes: 'Discovered 3 new high-LTV lookalike segments from conversion data',
    },
    {
      id: 'a4',
      title: 'AI Bid Strategy Adjustment',
      platform: 'AI Agent',
      status: 'Optimizing',
      type: 'draft',
      startDate: pad(8),
      notes: 'Switched Google PMax to target CPA from maximize conversions — projected 12% efficiency gain',
    },
    {
      id: 'a5',
      title: 'AI Pause Recommendation',
      platform: 'AI Agent',
      status: 'Review',
      type: 'draft',
      startDate: pad(9),
      notes: 'Suggested pausing 2 ad sets with CPA 3.2x above target over 7-day window',
    },
    {
      id: 'a6',
      title: 'AI Morning Optimization Complete',
      platform: 'AI Agent',
      status: 'Generated',
      type: 'report',
      startDate: pad(11),
      time: '08:30',
      notes: 'Daily budget pacing adjusted. 6 rules triggered. $340 reallocated.',
    },
    {
      id: 'a7',
      title: 'AI Creative A/B Winner Declared',
      platform: 'AI Agent',
      status: 'Generated',
      type: 'report',
      startDate: pad(13),
      time: '14:00',
      notes: 'Video variant B won with 34% lower CPC. Auto-promoted to primary ad.',
    },
    {
      id: 'a8',
      ...
      type: 'draft',
      startDate: pad(16),
      notes: 'CTR drop detected on Meta campaign (-42%). Root cause: audience overlap.',
    },
    {
      id: 'a9',
      title: 'AI Cross-Platform Attribution',
      platform: 'AI Agent',
      status: 'Generated',
      type: 'report',
      startDate: pad(17),
      time: '09:00',
      notes: 'Re-attributed 23 conversions from last-click to data-driven model.',
    },
    {
      id: 'a10',
      title: 'AI Campaign Auto-Scaling',
      platform: 'AI Agent',
      status: 'Optimizing',
      type: 'draft',
      startDate: pad(19),
      notes: 'ROAS threshold met for 3 days. AI increased daily budget by 25% on winning campaigns.',
    },
    {
      id: 'a11',
      title: 'AI Audience Overlap Fix',
      platform: 'AI Agent',
      status: 'Optimizing',
      type: 'draft',
      startDate: pad(21),
      notes: 'Consolidated 4 overlapping audiences into 2 optimized segments.',
    },
    {
      id: 'a12',
      ...
      startDate: pad(23),
      time: '08:00',
      notes: 'Week-over-week: +14% revenue, -8% CPA, +22% conversion rate. 5 optimizations applied.',
    },
    {
      id: 'a13',
      title: 'AI Creative Generation Batch',
      platform: 'AI Agent',
      status: 'Draft',
      type: 'draft',
      startDate: pad(24),
      notes: 'Generated 12 new ad variants from top-performing headlines and visuals. Awaiting approval.',
    },
    {
      id: 'a14',
      title: 'AI Forecast Alert',
      platform: 'AI Agent',
      status: 'Review',
      type: 'draft',
      startDate: pad(26),
      notes: 'Projected budget underspend by $4,200. Recommended 3 new campaign launches.',
    },
    {
      id: 'a15',
      title: 'AI Full-Funnel Optimization',
      platform: 'AI Agent',
      status: 'Optimizing',
      type: 'draft',
      startDate: pad(27),
      notes: 'Rebalanced TOFU/MOFU/BOFU spend ratio from 40/35/25 to 35/35/30 based on CAC trends.',
    },
    {
      id: 'a16',
      title: 'AI Month-End Report',
      platform: 'AI Agent',
      status: 'Scheduled',
      type: 'report',
      startDate: pad(30),
      time: '09:00',
      notes: 'Comprehensive monthly performance analysis with recommendations for next month.',
    },
    ...
    /* ═══════════════════ SCHEDULED REPORTS ═══════════════════ */
    {
      ...
      startDate: pad(1),
      time: '09:00',
      notes: 'Cross-platform performance summary with KPI dashboard',
    },
    {
      id: 'r2',
      ...
      startDate: pad(3),
      time: '14:00',
      notes: 'Ad creative rankings by CTR, conversion rate, and ROAS',
    },
    {
      id: 'r3',
      ...
      startDate: pad(5),
      time: '10:00',
      notes: 'High-level executive report with budget pacing and key wins',
    },
    {
      id: 'r4',
      ...
      startDate: pad(7),
      time: '11:00',
      notes: 'Demographic breakdown and audience segment performance analysis',
    },
    {
      id: 'r5',
      ...
      startDate: pad(15),
      time: '15:00',
      notes: 'Budget pacing check with reallocation recommendations',
    },
    {
      id: 'r6',
      ...
      startDate: pad(17),
      time: '13:00',
      notes: 'Auction insights, share of voice, and competitor spend estimates',
    },
    {
      id: 'r7',
      title: 'ROAS Deep Dive',
      platform: 'Report',
      status: 'Scheduled',
      type: 'report',
      startDate: pad(19),
      time: '10:00',
      notes: 'Platform-level ROAS analysis with attribution model comparison',
    },
    {
      id: 'r8',
      title: 'Weekly Performance Report',
    ...
    },
    {
      ...
      startDate: pad(24),
      time: '14:00',
      notes: 'First-click vs last-click vs data-driven attribution comparison',
    },
    {
      id: 'r10',
      title: 'Month-End Performance Report',
      platform: 'Report',
      status: 'Scheduled',
      type: 'report',
      startDate: pad(30),
      time: '17:00',
      notes: 'Full monthly performance review with learnings and recommendations',
    },

    /* ═══════════════════ GOALS & MILESTONES ═══════════════════ */
    {
      id: 'g1',
      title: 'ROAS Goal Check — Q3 Target 4.5x',
      platform: 'Custom',
      status: 'Scheduled',
      type: 'goal',
      startDate: pad(5),
      notes: 'Evaluate if blended ROAS meets quarterly target',
    },
    {
      id: 'g2',
      title: 'Creative Refresh Deadline',
      platform: 'Custom',
      status: 'Due',
      type: 'goal',
      startDate: pad(8),
      time: '17:00',
      notes: 'Replace all ad creatives running >14 days with frequency >2.5',
    },
    {
      id: 'g3',
      title: 'Budget Reallocation Sign-Off',
      platform: 'Custom',
      status: 'Scheduled',
      type: 'goal',
      startDate: pad(10),
      time: '12:00',
      notes: 'Approve AI-suggested budget shifts for next 2-week period',
    },
    {
      id: 'g4',
      title: 'New Audience Launch Deadline',
      platform: 'Custom',
      status: 'Scheduled',
      type: 'goal',
      startDate: pad(12),
      time: '10:00',
      notes: 'Launch 3 new lookalike audiences identified by AI analysis',
    },
    {
      id: 'g5',
      title: 'Mid-Month CPA Review',
      platform: 'Custom',
      status: 'Scheduled',
      type: 'goal',
      startDate: pad(15),
      notes: 'Check CPA across all platforms against $45 target',
    },
    {
      id: 'g6',
      ...
      startDate: pad(18),
      time: '09:00',
      notes: 'Prepare monthly client review deck with wins and recommendations',
    },
    {
      id: 'g7',
      title: 'UTM Parameter Audit',
      platform: 'Custom',
      status: 'Scheduled',
      type: 'goal',
      startDate: pad(20),
      notes: 'Verify all active campaigns have correct UTM tracking parameters',
    },
    {
      id: 'g8',
      title: 'Pixel Health Check',
      platform: 'Custom',
      status: 'Scheduled',
      type: 'goal',
      startDate: pad(22),
      notes: 'Verify Meta Pixel, GA4, and TikTok pixel firing correctly across all pages',
    },
    {
      id: 'g9',
      ...
      startDate: pad(25),
      time: '14:00',
      notes: 'Plan campaign strategy and budget allocation for Q3',
    },
    {
      id: 'g10',
      ...
      startDate: pad(30),
      time: '18:00',
      notes: 'Reconcile ad spend across all platforms against budget',
    },
    ...
    /* ═══════════════════ CAMPAIGN ENDS ═══════════════════ */
    {
      ...
      endDate: pad(3),
      budget: '$500/day',
      notes: 'Campaign concluded. Final ROAS: 3.8x. Learnings documented.',
    },
    {
      id: 'e2',
      title: 'Holiday Retargeting Blitz',
      platform: 'Google',
      status: 'Ended',
      type: 'campaign',
      startDate: pad(2),
      endDate: pad(4),
      budget: '$600/day',
      notes: 'Flash sale retargeting campaign concluded. CPA: $38.',
    },
    {
      id: 'e3',
      ...
      endDate: pad(5),
      budget: '$350/day',
      notes: 'Teaser campaign ended. Drove 12K landing page views.',
    },
  ]
}

const MOCK_EVENTS: CalendarEvent[] = generateMockEvents()
...
export default function CampaignCalendar() {
  ...
  const filteredEvents = useMemo(
    () => events.filter(e => activeTypes.has(e.type) && activePlatforms.has(e.platform)),
    [events, activeTypes, activePlatforms]
  )
  ...
  return (
    ...
    <SEO
      title="Calendar"
      description="Plan and manage your marketing calendar. Schedule campaigns, content, and team activities with a visual calendar interface."
      keywords="calendar, marketing calendar, schedule, content planning"
    />
          ...
          <div className="flex gap-6">
            ...
            <aside className="hidden xl:block w-72 shrink-0 space-y-5">
              ...
              {isDemo && (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-semibold" style={{ color: '#10B981' }}>Demo Mode Active</span>
                  </div>
                  <p className="text-[11px]" style={{ color: 'var(--text-secondary)' }}>
                    Showing {events.length} realistic mock events including campaign launches, AI optimizations, scheduled reports, and goals.
                  </p>
                </div>
              )}
              ...
              <div className="rounded-xl p-4" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
                <h3 className="font-space font-medium text-sm mb-3" style={{ color: 'var(--text-primary)' }}>This Month</h3>
                <div className="grid grid-cols-2 gap-2">
                  {[
                    { label: 'Campaigns', count: events.filter(e => e.type === 'campaign').length, color: '#3B82F6', icon: <Megaphone size={10} /> },
                    { label: 'AI Actions', count: events.filter(e => e.platform === 'AI Agent').length, color: '#10B981', icon: <Bot size={10} /> },
                    { label: 'Reports', count: events.filter(e => e.type === 'report').length, color: '#8B5CF6', icon: <BarChart3 size={10} /> },
                    { label: 'Goals', count: events.filter(e => e.type === 'goal').length, color: '#10B981', icon: <Target size={10} /> },
                  ].map(({ label, count, color, icon }) => (
                    <div key={label} className="rounded-lg p-2 text-center" style={{ background: 'var(--bg-secondary)' }}>
                      <div className="flex items-center justify-center gap-1 mb-1">
                        <span style={{ color }}>{icon}</span>
                        <span className="text-lg font-bold font-space" style={{ color }}>{count}</span>
                      </div>
              ...
              <div className="rounded-xl p-4" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    ['Draft', '#F59E0B', 'AI drafts and pending actions'],
      ...
      <span
        ...
        style={{
          background: ev.status === 'Active' || ev.status === 'Running' ? '#10B981'
            : ev.status === 'Optimizing' ? '#10B981'
            : ev.status === 'Ended' ? '#EF4444'
            : ev.status === 'Scheduled' ? '#F59E0B'
            : ev.status === 'Review' ? '#F59E0B'
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {ev.notes && (
                          <p className="text-[10px] mt-1" style={{ color: 'var(--text-tertiary)' }}>{ev.notes}</p>
                        )}
                      </div>
...
function StatusBadge({ status }: { status: EventStatus }) {
  const color =
    status === 'Active' || status === 'Running' || status === 'Optimizing' ? 'rgba(16,185,129,0.15)'
    : status === 'Ended' ? 'rgba(239,68,68,0.15)'
    : status === 'Scheduled' || status === 'Pending' ? 'rgba(245,158,11,0.15)'
    : status === 'Review' ? 'rgba(245,158,11,0.15)'
    : status === 'Draft' ? 'rgba(139,92,246,0.15)'
    : 'rgba(59,130,246,0.15)'
  const text =
    status === 'Active' || status === 'Running' || status === 'Optimizing' ? '#10B981'
    : status === 'Ended' ? '#EF4444'
    : status === 'Scheduled' || status === 'Pending' ? '#F59E0B'
