...
const tiers = [
  {
    id: 'growth',
    name: 'Growth',
    description: 'For media buyers with $5–50K/mo ad spend',
    monthlyPrice: 79,
    annualPrice: 658,
    ...
    icon: TrendingUp,
    features: [
      { text: 'Meta + Google Ads', icon: Globe },
      { text: 'Basic AI rules engine', icon: Bot },
      { text: 'Campaign dashboard', icon: BarChart3 },
      { text: 'Weekly email reports', icon: Bell },
  ...
  },
  {
    id: 'scale',
    name: 'Scale',
    description: 'For media buyers with $50–200K/mo ad spend',
    monthlyPrice: 199,
    annualPrice: 1658,
    cta: 'Start Free Trial',
    ctaLink: '/signup',
    ...
    features: [
      ...
      { text: 'Morning Brief daily digest', icon: Bell },
      { text: 'Creative fatigue detection', icon: Sparkles },
      { text: 'Competitive intelligence', icon: Shield },
  ...
  },
  {
    id: 'accelerate',
    name: 'Accelerate',
    description: 'For agencies and $200K+/mo ad spend',
    monthlyPrice: 499,
    annualPrice: 4158,
    cta: 'Contact Sales',
    ctaLink: 'mailto:sales@campaignagent.ai',
    ctaStyle: 'accent' as const,
    popular: false,
    icon: Building2,
    features: [
      { text: 'Everything in Scale +', icon: Star, highlight: true },
      ...
      { text: 'Unlimited team members', icon: Infinity },
    ],
    nonFeatures: [],
  },
]
