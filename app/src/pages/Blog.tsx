...
export default function Blog() {
  ...
  return (
    ...
    <SEO
      title="Blog"
      description="Latest insights on AI advertising, campaign optimization, marketing strategies, product updates, and industry trends from AdNexus AI."
      keywords="blog, AI advertising, marketing insights, campaign tips, product updates"
    />
              ...
              <div className="max-w-6xl mx-auto">
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    {/* Thumbnail */}
                    <Link to={`/blog/${featuredPost.slug}`} className="relative block h-64 lg:h-auto">
                      <div
                    ...
                    <div className="flex flex-col justify-center p-8 lg:p-10">
                      ...
                      <Link to={`/blog/${featuredPost.slug}`} className="block mb-3">
                        <h2
